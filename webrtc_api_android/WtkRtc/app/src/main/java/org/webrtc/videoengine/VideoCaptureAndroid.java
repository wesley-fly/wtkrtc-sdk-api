...
public class VideoCaptureAndroid implements PreviewCallback, Callback {
  ...
  public int SetCamera(int width,int height, int min_mfps, int max_mfps, int deviceId) {
    Log.d(TAG, "SetCamera( " + deviceId + " )");
    if (camera != null) {
        stopCapture();
        this.id = deviceId;
        startCapture(width,height,min_mfps,max_mfps);
    }
