...
class AndroidStream : public rtc::VideoSinkInterface<VideoFrame> {
 public:
...
class VideoRenderAndroid: IVideoRender {
 public:
  ...
  virtual rtc::VideoSinkInterface<VideoFrame>* AddIncomingRenderStream(
  ...
  virtual VideoType PerferedVideoType();
