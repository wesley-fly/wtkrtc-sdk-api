...
JNIEXPORT JNICALL void Java_com_wtk_mobile_jni_WtkMediaJNI_SetVideoView(JNIEnv *env, jobject obj,jobject RemoteSurfaceView);
...
JNIEXPORT JNICALL void Java_com_wtk_mobile_jni_WtkMediaJNI_SwitchCamera(JNIEnv *env, jobject obj,jint callNo,int deviceId);
