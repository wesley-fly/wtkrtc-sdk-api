...
extern int iax_ie_append_versioned_uint64(struct iax_ie_data *ied, unsigned char ie, unsigned char version, uint64_t value);
...
extern int iax_ie_append_ticket_str(struct iax_ie_data *ied, unsigned char ie, const char *str);
