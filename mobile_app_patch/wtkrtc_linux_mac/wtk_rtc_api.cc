...
#define USED_VIDEO_CODEC_VP8
//#define USED_VIDEO_CODEC_VP9
//#define USED_VIDEO_CODEC_H264
...
void CreateVideoSendStream(void)
{
...
#endif
#ifdef USED_VIDEO_CODEC_VP9
	video_send_config.rtp.payload_name = "VP9";
	video_send_config.rtp.payload_type = kPayloadTypeVP9;
	video_send_config.encoder_settings.encoder = webrtc::VP9Encoder::Create().release();
#endif
#ifdef USED_VIDEO_CODEC_H264
	video_send_config.rtp.payload_name = "H264";
	video_send_config.rtp.payload_type = kPayloadTypeH264;
	video_send_config.encoder_settings.encoder = webrtc::H264Encoder::Create(cricket::VideoCodec("H264")).release();
#endif
	...
	encoder_config.video_stream_factory = new rtc::RefCountedObject<cricket::EncoderStreamFactory>("VP9", USED_MAX_VIDEO_QP, USED_VIDEO_FPS, false, false);
#endif
#ifdef USED_VIDEO_CODEC_H264
	...
	encoder_config.video_stream_factory = new rtc::RefCountedObject<cricket::EncoderStreamFactory>("H264", USED_MAX_VIDEO_QP, USED_VIDEO_FPS, false, false);
#endif
...
void CreateVideoReceiveStream(void)
{
...
#endif
#ifdef USED_VIDEO_CODEC_VP9
	video_rev_config.rtp.rtx_associated_payload_types[kPayloadTypeRtx] = kPayloadTypeVP9;
#endif
#ifdef USED_VIDEO_CODEC_H264
	video_rev_config.rtp.rtx_associated_payload_types[kPayloadTypeRtx] = kPayloadTypeH264;
#endif
	...
	decoder_config.payload_type = kPayloadTypeVP9;
	decoder_config.decoder = webrtc::VP9Decoder::Create().release();
#endif
#ifdef USED_VIDEO_CODEC_H264
	decoder_config.payload_name = "H264";
	decoder_config.payload_type = kPayloadTypeH264;
