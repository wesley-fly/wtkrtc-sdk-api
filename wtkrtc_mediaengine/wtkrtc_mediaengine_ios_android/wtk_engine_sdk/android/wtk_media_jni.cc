...
jint Java_com_wtk_mobile_jni_WtkMediaJNI_IaxInitialize(JNIEnv* env,jobject obj,jobject jlistener,jobject context)
{
	...
	wtkcall_set_iax_event_callback(AppAllEventCallback);
...
jint Java_com_wtk_mobile_jni_WtkMediaJNI_IaxRegister(JNIEnv* env,jobject obj,jstring name, jstring number, jstring pass, jstring host, jstring port,jint refresh)
{
	...
	ret = wtkcall_register(pName,pNumber,pPass,pHost,refresh);
...
void Java_com_wtk_mobile_jni_WtkMediaJNI_SetVideoView(JNIEnv *env, jobject obj,jobject LocalSurfaceView,jobject RemoteSurfaceView)
{
	JNILOGI("%s,line %d", __FUNCTION__,__LINE__);
	wtkcall_set_render(LocalSurfaceView,RemoteSurfaceView); 
}
void Java_com_wtk_mobile_jni_WtkMediaJNI_SwitchCamera(JNIEnv *env, jobject obj,int deviceId)
{
	JNILOGI("%s,line %d", __FUNCTION__,__LINE__);
	wtkcall_switch_camera(deviceId); 
}
