...
extern int iax_send_voice(struct iax_session *session, uint64_t format, unsigned char *data, int datalen, int samples);
...
extern uint64_t iax_session_get_capability(struct iax_session *s);
