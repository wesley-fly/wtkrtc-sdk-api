...
void VcmCapturer::SetCaptureRotation(VideoRotation rotation) {
  vcm_->SetCaptureRotation(rotation);
}
void VcmCapturer::SetCaptureDevice(int deviceId) {
  vcm_->SetCaptureDevice(deviceId);
}
#ifdef WEBRTC_IOS
void VcmCapturer::SetVideoPreviewRender(void* preview) {
  vcm_->SetVideoPreviewRender(preview);
}
#endif
