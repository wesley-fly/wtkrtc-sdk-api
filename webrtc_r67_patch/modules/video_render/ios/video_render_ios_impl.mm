...
int32_t VideoRenderIosImpl::Init() {
  ...
  //For fix view context is NULL
  UIView* iOSUIView = (__bridge UIView*)ptr_window_;
  VideoRenderIosView* view = [[VideoRenderIosView alloc] initWithFrame:CGRectMake(0, 0,iOSUIView.frame.size.width, iOSUIView.frame.size.height)];
  ptr_ios_render_.reset(new VideoRenderIosGles20(view,iOSUIView, full_screen_, id_));

  //ptr_ios_render_.reset(new VideoRenderIosGles20((__bridge VideoRenderIosView*)ptr_window_, full_screen_, id_));
