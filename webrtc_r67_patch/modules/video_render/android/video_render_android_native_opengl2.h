...
class AndroidNativeOpenGl2Channel: public AndroidStream {
 public:
  ...
  //Implement rtc::VideoSinkInterface<VideoFrame>
  virtual void OnFrame(const VideoFrame& videoFrame) override;

  //Implements AndroidStream
  virtual void DeliverFrame(JNIEnv* jniEnv) override;
 private:
  ...
  void DrawNative();
  rtc::CriticalSection _renderCritSect;
