...
class VideoCaptureIos : public VideoCaptureImpl {
 public:
  ...
  int32_t GetCaptureDevice() override;
  int32_t SetCaptureDevice(int32_t deviceId) override;
  int32_t SetVideoPreviewRender(void* view) override;
  int32_t RegDisplayPreviewData() override;
  int32_t UnRegDisplayPreviewData() override;

 private:
  RTCVideoCaptureIosObjC* capture_device_;
  bool is_capturing_;
  VideoCaptureCapability capability_;
  int32_t cur_device_id_;
};
