...
public:
   ...
   static rtc::scoped_refptr<VideoCaptureModule> Create(
    ...
    int32_t SetVideoPreviewRender(void* view) override { return -1; }
    int32_t RegDisplayPreviewData() override { return -1; }
    int32_t UnRegDisplayPreviewData() override { return -1; }
#endif
